...
##### Navigational Bar 
Heading each page top, it’s fully responsive and toggles to a neat hambuger menu. It contains links to all pages, reachable at any time within the journey through the site. The Logo contains the link to the home page. 
...
- coolors.co - the color scheme was inspired by colours generated here 
...
- mulit device mock up generator - to create an image displaying the home page on various devices 

## Testing
Please refer here for more information on testing of Pawsome Portraits


The site was deployed ti GitHub pages. 
...
### Content 
- The hamburger menu was inspired by a youtube tutorial LINK
- The image gallery was inspried by this youtube tutorial  link
- The sticky footer was inspired by this tutorial 
- Many issues were at least partly resolved by searching Stack Overflow 
...
## Acknowledgements 
This website was executed and completed as a portfolio 1 Project for the full stack diploma at code institute. 
